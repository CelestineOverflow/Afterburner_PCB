...
//1123379/1717296/2.50/12/3/Connector
...
(library Library_1
	...
	(patternDef "SHDR12W64P0X250_1X12_3240X575X" (originalName "SHDR12W64P0X250_1X12_3240X575X")
		(multiLayer
			...
			(pad (padNum 11) (padStyleRef c165_h110) (pt 25, 0) (rotation 90))
			(pad (padNum 12) (padStyleRef c165_h110) (pt 27.5, 0) (rotation 90))
		)
		...
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt -2.7 3.65) (pt 30.2 3.65) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 30.2 3.65) (pt 30.2 -2.6) (width 0.05))
		)
		(layerContents (layerNumRef Courtyard_Top)
			(line (pt 30.2 -2.6) (pt -2.7 -2.6) (width 0.05))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.45 -2.35) (pt -2.45 3.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt -2.45 3.4) (pt 29.95 3.4) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.95 3.4) (pt 29.95 -2.35) (width 0.025))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.95 -2.35) (pt -2.45 -2.35) (width 0.025))
		)
		(layerContents (layerNumRef 18)
			(line (pt 0 -2.35) (pt 29.95 -2.35) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 29.95 -2.35) (pt 29.95 3.4) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt 29.95 3.4) (pt -2.45 3.4) (width 0.2))
		)
		(layerContents (layerNumRef 18)
			(line (pt -2.45 3.4) (pt -2.45 0) (width 0.2))
		)
	)
	(symbolDef "B12B-XH-A_LF__SN_" (originalName "B12B-XH-A_LF__SN_")
	...
	(compDef "B12B-XH-A_LF__SN_" (originalName "B12B-XH-A_LF__SN_") (compHeader (numPins 12) (numParts 1) (refDesPrefix J)
		)
		...
		(attachedSymbol (partNum 1) (altType Normal) (symbolName "B12B-XH-A_LF__SN_"))
		(attachedPattern (patternNum 1) (patternName "SHDR12W64P0X250_1X12_3240X575X")
			(numPads 12)
			(padPinMap
		...
		(attr "Mouser Part Number" "306-B12BXHALFSN")
		(attr "Mouser Price/Stock" "https://www.mouser.co.uk/ProductDetail/JST-Commercial/B12B-XH-ALFSN?qs=cdbOS8ANM9DlDe0nA7fEWA%3D%3D")
		(attr "Manufacturer_Name" "JST (JAPAN SOLDERLESS TERMINALS)")
		(attr "Manufacturer_Part_Number" "B12B-XH-A(LF)(SN)")
		(attr "Description" "CONN HEADER XH TOP 12POS 2.5MM")
		(attr "<Hyperlink>" "http://www.jst-mfg.com/product/pdf/eng/eXH.pdf")
		(attr "<Component Height>" "7")
		(attr "<STEP Filename>" "B12B-XH-A_LF__SN_.stp")
