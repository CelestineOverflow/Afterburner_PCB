...
(library Library_1
	...
	(patternDef "SHDR12W64P0X250_1X12_3240X575X" (originalName "SHDR12W64P0X250_1X12_3240X575X")
		...
		(layerContents (layerNumRef 28)
			(line (pt -2.45 3.4) (pt 29.95 3.4) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.95 3.4) (pt 29.95 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 28)
			(line (pt 29.95 -2.35) (pt -2.45 -2.35) (width 0.1))
		)
		(layerContents (layerNumRef 18)
	...
	(compDef "B12B-XH-A_LF__SN_" (originalName "B12B-XH-A_LF__SN_") (compHeader (numPins 12) (numParts 1) (refDesPrefix J)
		...
		(attr "Datasheet Link" "http://www.jst-mfg.com/product/pdf/eng/eXH.pdf")
		(attr "Height" "7 mm")
	)
